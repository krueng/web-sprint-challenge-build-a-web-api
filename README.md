...
- Node.js is a back-end platform for building web application, it is on server side as opposed to front-end which is the clients' side.
- Express is a framework for Node.js, as it in React for front-end.

1. Understand and explain the use of Middleware.
- Middleware is like an intermediary between server and users, its a place where request and response intercharged and modified.

1. The basic principles of the REST architectural style.
- The REpresentational State Transfer in its basic principal is cacheable, its purpose is to improve performance. It provides a uniform interface between components and revolves around resources where every components is a resource that can be accessed by common interface using HTTP standard methods

1. Understand and explain the use of Express Routers.
- Express Router help developers create router handler as well as validation, path, error and also took care some security issue.  

1. Describe tooling used to manually test the correctness of an API.
- Mainly use Postman, HTTPie, and curl. With these any request can be made directly. Therefore it speeds up the test process when the tool responded to the request.